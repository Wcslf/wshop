    ...
    */
    public function _initialize()
    {
        ...
        $nologin = array(
            ...
            'forget_pwd', 'check_captcha', 'check_username', 'send_validate_code', 'bind_guide', 'bind_account','bind_reg'
        );
    ...
    */
    ...
    public function withdrawals()
    {
        ...
        if (IS_POST) {
            ...
            $bank['bank_name'] = $data['bank_name'] = trim(I('post.bank_name', ''));
            $bank['bank_card'] = $data['bank_card'] = trim(I('post.bank_card/d', ''));
            $bank['realname'] = $data['realname'] = trim(I('post.realname', ''));

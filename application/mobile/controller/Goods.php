...
class Goods extends MobileBase {
    ...
    public function goodsInfo(){
        ...
        $spec_goods_price = Db::name('spec_goods_price')->where("goods_id",$goods_id)->getField("key,price,store_count,item_id"); // 规格 对应 价格 库存表
        ...
        $goods_attr = $Goods->goodsAttr()->join('tp_goods_attribute','tp_goods_attribute.attr_id=tp_goods_attr.attr_id','left')->where('tp_goods_attribute.attr_index',1)->where('tp_goods_attr.goods_id',$goods_id)->order('tp_goods_attribute.order DESC')->select();
    ...
    public function ajaxComment()
    {
        ...
        foreach ($list as $k => $v) {
            ...
            $list[$k]['content'] = json_decode($v['content']);//给雄霸反解码
        }

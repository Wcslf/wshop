...
class Store extends Base {
    ...
    public function index()
    {
        ...
        //热卖商品
        $hot_goods_list = M('goods')->field('goods_content',true)->where(array('store_id'=>$store_id,'is_hot'=>1,'is_on_sale'=>1))->order('goods_id desc')->limit(10)->select();
    ...
    public function storeGoods()
    {
        ...
        $store_goods_list['goods_list'] = M('goods')
            ->field('goods_id,cat_id3,goods_sn,goods_name,shop_price,comment_count,sales_sum,is_virtual')

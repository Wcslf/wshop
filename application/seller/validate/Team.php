...
//        'team_price'                =>['require','regex'=>'([1-9]\d*(\.\d*[1-9])?)|(0\.\d*[1-9])','checkTeamPrice'],
        ...
        'virtual_num'               =>'number',
        'share_title'               =>'require|max:50',
        'share_desc'                =>'require|max:200',
        'share_img'                 =>'require',
...
//        'team_price.checkTeamPrice' => '拼团价格必须低于单买价格',
        ...
        'share_title.require'       => '分享标题必须',
        'share_desc.max'            => '分享描述长度不得超过200字符',
        'share_desc.require'        => '分享描述必须',
        'share_img.require'         => '分享图片必须',
    ];

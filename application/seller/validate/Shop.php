...
class Shop extends Validate
{
    ...
    protected $rule = [
        ...
        'shop_images' => 'require|length:1,5',
    ...
    protected $message = [
        ...
        'shop_name.require' => '自提点名称必须',
        'shop_name.max' => '自提点名称长度不得超过20字符',
        'shop_name.unique' => '自提点名称已存在',
        'user_name.require' => '会员账号必须',
        'password.require' => '密码必须',
        'shopper_name.require' => '自提点账号必须',
        'shopper_name.unique' => '自提点账号已被占用',
        ...
        'shop_images.require' => '自提点照片必须',
        'shop_images[].length' => '自提点照片数量1至5张',

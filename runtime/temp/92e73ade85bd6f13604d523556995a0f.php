<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./template/mobile/default/goods/goodsInfo.html";i:1541580872;s:74:"/www/wwwroot/shop.zequninfo.com/template/mobile/default/public/header.html";i:1532948114;s:75:"/www/wwwroot/shop.zequninfo.com/template/mobile/default/public/top_nav.html";i:1532948114;s:76:"/www/wwwroot/shop.zequninfo.com/template/mobile/default/public/wx_share.html";i:1532948114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
        ...
        <div class="mslide" id="slideTpshop">
            <ul>
                ...
                <?php if(is_array($goods['goods_images']) || $goods['goods_images'] instanceof \think\Collection || $goods['goods_images'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goods['goods_images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$img): $mod = ($i % 2 );++$i;?>
                    <li><a href="javascript:void(0)"><img src="<?php echo $img[image_url]; ?>"></a></li>
    ...
    <div class="de_font p">
        <div class="thirty">
            ...
            <div class="scunde p">
                ...
                <p>销量：<span>1</span><span> 当前库存：<span class="spec_store_count">99</span>
                    </span>
                </p>
                <p><span id="market_price_title">市场价：</span><span class="linethr" id="market_price"><?php echo $goods['market_price']; ?></span></p>
                <p class="pre_sell_div" style="display: none">
                    订金：<span id="deposit_price"></span><span>尾款：<span id="balance_price"></span></span>
                </p>
    ...
    <div class="floor list7 detailsfloo">
                ...
                <a href="javascript:void(0)">
                    <div class="order">
                        <div class="fl">
                            ...
                            <span>由<?php echo $goods['store']['store_name']; ?>提供服务</span>
        ...
        <div class="myhearders myorder">
            <div class="scgz descgz">
                <ul>
                    <?php if($goods['store']['certified'] == 1): ?>
                        <li>
                            <a href="javascript:void(0);">
                                <img src="/template/mobile/default/static/images/hdfk.png">
                                <p>正品保障</p>
                            </a>
                        </li>
                    <?php endif; if($goods['store']['qitian'] == 1): ?>
                        <li>
                            <a href="javascript:void(0);">
                    ...
                    <?php endif; if($goods['store']['two_hour'] == 1): ?>
                        <li>
                            <a href="javascript:void(0);">
                                <img src="/template/mobile/default/static/images/ksd.png">
                                <p>极速达</p>
                            </a>
                        </li>
                    <?php endif; ?>
                ...
                <a href="javascript:void(0)">
                    <div class="order">
                        <div class="fl">
                            ...
                            <span>好评率<i><?php echo $goods['comment_statistics']['high_rate']; ?></i></span>
                        </div>
                        <div class="fr">
        ...
        <div class="storemess">
            <div class="maleri30">
                <div class="top_storeme p">
                    <div class="spelee">
                        <a href="<?php echo U('Store/index',array('store_id'=>$goods[store_id])); ?>">
                            <img src="<?php echo $goods['store']['store_avatar']; ?>">
                        </a>
                    </div>
                    <div class="nxnan">
                        <a href="<?php echo U('Store/index',array('store_id'=>$goods[store_id])); ?>">
                            <h2><?php echo $goods['store']['store_name']; ?></h2>

                            <p><span><?php echo $goods['store']['seo_description']; ?></span></p>
                        </a>
                    </div>
                    <div class="alldeyy">
                        <span>综合<em class="red"><?php echo number_format($goods['store']['total_credit'],2); ?></em></span>
                    </div>
                </div>
                        ...
                        <li>
                            <div class="commeaye">
                                <p class="sh_pp"><span>商品</span>
                                    <span class="red"><em><?php echo $goods['store']['store_desccredit']; ?></em>&nbsp;<?php echo getStoreScoreDec($goods['store']['store_desccredit']); ?></span>
                                </p>
                                <p class="sh_sz"><span><?php echo $goods['store']['store_sales']; ?></span></p>
                                <p class="sh_ep"><span>销量</span></p>
                            </div>
                        </li>
                        <li>
                            <div class="commeaye">
                                <p class="sh_pp"><span>服务</span><span class="red"><em><?php echo $goods['store']['store_servicecredit']; ?></em>&nbsp;<?php echo getStoreScoreDec($goods['store']['store_servicecredit']); ?></span></p>
                                <p class="sh_sz"><span><?php echo $goods['store']['store_collect']; ?></span></p>
                                <p class="sh_ep"><span>收藏</span></p>
                            </div>
                        </li>
                        <li>
                            <div class="commeaye">
                                <p class="sh_pp"><span>物流</span><span class="red"><em><?php echo $goods['store']['store_deliverycredit']; ?></em>&nbsp;<?php echo getStoreScoreDec($goods['store']['store_deliverycredit']); ?></span></p>
                                <p class="sh_sz"><span><?php echo $goods['store']['store_sort']; ?></span></p>
                ...
                <div class="bot_storeme p">
                    <ul>
                        <li><a href="tel:<?php echo $goods['store']['service_phone']; ?>"><i class="kef"></i>联系客服</a></li>
                        <li><a href="<?php echo U('Store/index',array('store_id'=>$goods[store_id])); ?>"><i class="action-ak"></i>进入店铺</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="sg" style="display: none;">
        <div class="spxq p">
            <table class="de_table" border="1" bordercolor="#cbcbcb" style="border-collapse:collapse;">
                ...
                <?php if(is_array($goods_attr) || $goods_attr instanceof \think\Collection || $goods_attr instanceof \think\Paginator): $i = 0; $__LIST__ = $goods_attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$attr): $mod = ($i % 2 );++$i;?>
                    <tr>
                        <td><?php echo $goods_attribute[$attr[attr_id]]; ?></td>
            ...
            <ul>
                <li>
                    <?php if((!empty($kf_config['im_choose'])) && ($kf_config['im_choose'] == 1)): ?>
                        <!--im客服-->
                        <a class="kf" href="<?php echo U('supplier/index',array('store_id'=>$goods[store_id],'goods_id'=>$goods['goods_id'])); ?>">
                            <i></i>
                            <p>客服</p>
                        </a>
                        ...
                        <a href="mqqwpa://im/chat?chat_type=wpa&uin=<?php echo $goods['store']['store_qq']; ?>&version=1&src_type=web&web_src=www.chinesestack.com">
                            <i></i>
                            <p>客服</p>
                        </a>
                    <?php endif; ?>
...
<!--点赞弹窗-s-->
<div class="alert">
    <img src="/template/mobile/default/static/images/hh.png"/>
    <p>您已经赞过了！</p>
</div>
<!--点赞弹窗-e-->
...
<script type="text/javascript" src="/template/mobile/default/static/js/lefttime.js"></script>

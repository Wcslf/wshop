<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/plugin/index.html";i:1559450922;s:73:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/layout.html";i:1559450922;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="http://www.phpyuanmashe.com/articleList_cat_id_30.html" target="_blank"><span>云插件</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
                            ...
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <?php if($l['status'] == 0): ?>
                                        ...
                                        <?php else: ?>
                                        <a href="<?php echo U('Admin/Plugin/setting',array('type'=>$l['type'],'code'=>$l['code'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>配置</a>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/seller/new/goods/albumList.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/head.html";i:1540447900;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/left.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/foot.html";i:1559461632;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Goods/albumList'); ?>">相册列表</a></li>
                </ul>
            ...
            <form id="search-form2" method="post" action="<?php echo U('Goods/albumList'); ?>">
                <table class="search-form">
                    <tr>
                        <td></td>
                        <th class="w70">相册名称</th>
                        <td class="w100"><input style="width: 90px;" class="text" type="text" placeholder="搜索词" value="<?php echo $_POST['keyword']; ?>" name="keyword"/></td>
            ...
            <table class="ncsc-default-table">
                ...
                <tbody>
                <?php if(empty($albumList) || (($albumList instanceof \think\Collection || $albumList instanceof \think\Paginator ) && $albumList->isEmpty())): ?>
                    <tr>
                        <td colspan="20" class="norecord"><div class="warning-option"><i class="icon-warning-sign"></i><span>暂无符合条件的数据记录</span></div></td>
                    </tr>
                <?php else: if(is_array($albumList) || $albumList instanceof \think\Collection || $albumList instanceof \think\Paginator): $i = 0; $__LIST__ = $albumList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        <td></td>
                        <td><?php echo $list['id']; ?></td>
                        <td class="tl"><?php echo $list['album_name']; ?></td>
                        <td><a href="<?php echo (isset($list['album_img']) && ($list['album_img'] !== '')?$list['album_img']:'/public/images/default_goods_image_240.gif'); ?>" target="_blank"><img onmouseover="$(this).attr('width','80').attr('height','45');" onmouseout="$(this).attr('width','40').attr('height','30');" width="40" height="30" src="<?php echo (isset($list['album_img']) && ($list['album_img'] !== '')?$list['album_img']:'/public/images/default_goods_image_240.gif'); ?>"/></a></td>
                        <td><?php echo (isset($list['count']) && ($list['count'] !== '')?$list['count']:0); ?></td>
                        <td><?php echo (isset($list['album_remark']) && ($list['album_remark'] !== '')?$list['album_remark']:'无'); ?></td>
                        <td>
                            <?php if($list['sort'] == 0): ?>是<?php else: ?>否<?php endif; ?>
                        </td>
                        <td class="nscs-table-handle">
                        	<span><a href="<?php echo U('seller/Goods/album_image', array('album_id'=>$list['id'])); ?>" class="btn-bluejeans"><i class="icon-eye-open"></i><p>查看</p></a></span>
                            <span><a onclick="add_edit_album('<?php echo $list[id]; ?>')" class="btn-bluejeans"><i class="icon-edit"></i><p>编辑</p></a></span>
                            <span><a onclick="del_album('<?php echo $list[id]; ?>')" class="btn-grapefruit"><i class="icon-trash"></i><p>删除</p></a></span>
                        </td>
                    </tr>
...
<div id="footer">
  ...
  Copyright 2019<a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>" target="_blank"><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?></a> All rights reserved.<br />
...
<div id="tbox">
  ...
  <div class="btn" id="im"><i class="im"><em id="new_msg" style="display:none;"></em></i>
      <a href="tencent://message/?uin=<?php echo $tpshop_config['shop_info_qq3']; ?>&Site=<?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?>&Menu=yes">在线联系</a>
  </div>
...
function del_album(albumId){
	layConfirm("删除该相册的话会影响使用的图片!" , function(){
        ...
        $.ajax({
           type:'GET',
           url:"<?php echo U('Seller/Goods/delAlbum'); ?>",
           data:{'id':albumId},
           success:function(data){

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/seller/new/order/ajaxindex.html";i:1532948110;}*/ ?>
  ...
  <tbody>
    ...
    <tr>
      <th style="width:30px;text-align:center" rowspan="<?php echo count($goodslist)?>">
		  <!--<input type="checkbox" value="<?php echo $list['order_id']; ?>" />-->
	  </th>
      <th colspan="20">
    ...
    <?php else: ?>
    	...
    	<tr>
	      <td class="bdl"></td>
	      <td class="w70">
	      	<div class="ncsc-goods-thumb"><a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$good['goods_id'])); ?>" target="_blank"><img src="<?php echo goods_thum_images($good['goods_id'],240,240); ?>"  ></a></div>
	      </td>
	      <td class="tl">
	      	<dl class="goods-name">
	          <dt><a target="_blank" href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$good['goods_id'])); ?>"><?php echo $good['goods_name']; ?></a></dt>

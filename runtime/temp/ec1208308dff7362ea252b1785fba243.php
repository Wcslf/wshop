<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"./application/admin/view/index/index.html";i:1610688695;s:74:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/menubox.html";i:1532948112;s:71:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/left.html";i:1610684686;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="admincp-header">
  ...
  <div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
    <!-- <h2 style="cursor:pointer;">php源码社<br>平台系统管理中心</h2> -->
...
<!--      <li data-param="mobile"><a href="javascript:void(0);">模板</a></li>-->
  ...
  <div class="admincp-header-r">
    <div class="manager">
      ...
      <!--<dl>-->
        <!--<a href="##" id="testclick" style="color: #fff;" target="_blank" onclick="c()">-->
          <!--<dt class="name">php源码社</dt>-->
    ...
    <ul class="operate nc-row">
      <!-- li tptype="pending_matters"><a class="toast show-option" href="javascript:void(0);" onClick="$.cookie('commonPendingMatters', 0, {expires : -1});ajax_form('pending_matters', '待处理事项', 'http://eryueniaofei.top/admin/index.php?act=common&op=pending_matters', '480');" title="查看待处理事项">&nbsp;<em>0</em></a></li-->
...
<div class="admincp-container-left">
    	...
    	<dl>
		    ...
		    <dd class="sub-menu">
			    <ul>
				    ...
				    <li><a href="javascript:void(0);" data-param="explain|Index">业务流程</a></li>
			    </ul>
		    </dd>
	    </dl>
    </div>
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?> 
    <!--<div class="about" title="关于系统" onclick="javascript:layer.open({type: 2,title: '关于我们',shadeClose: true,shade: 0.3,area: ['50%', '60%'],content:'<?php echo U("Index/about"); ?>', });"><i class="fa fa-copyright"></i><span>phpyuanmashe</span></div>-->
</div>

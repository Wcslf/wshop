<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/admin/view/public/dispatch_jump.html";i:1559451096;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
		<div class="rectangle_box">
			...
			<div class="recigle">
				<p>Copyright©2014-2019<em class="copyright"><a class="copyright" href="http://eryueniaofei.top/"><?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?> v3.x</a></em></p>
				<p><em class="copyright"><a class="copyright" href="http://eryueniaofei.top/"><?php echo (isset($tpshop_config['shop_info_store_title']) && ($tpshop_config['shop_info_store_title'] !== '')?$tpshop_config['shop_info_store_title']:'深圳二月鸟飞有限公司'); ?></a></em>出品</p>
			</div>
		</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./template/pc/rainbow/cart/header_cart_list.html";i:1532948120;}*/ ?>
                    ...
                    <dd class="c-list">
                        <div class="c-prod"><!-- 临时屏蔽 -->
                            ...
                            <div class="c-item fixed  js_cart_pro_list">
                                ...
                                <p class="i fl mr5">
                                    <a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$cart[goods_id])); ?>"> <img src="<?php echo goods_thum_images($cart['goods_id'],50,50); ?>" height="50" width="50" alt="" title="<?php echo $cart[goods_name]; ?>"></a>
                                </p>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"./application/admin/view/ad/adList.html";i:1540447900;s:73:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/layout.html";i:1559450922;}*/ ?>
<!doctype html>
<html>
<head>
              ...
              <td align="center">
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 100px;">                    
                    ...
                    <a href="<?php echo U('Ad/ad',array('act'=>'edit','ad_id'=>$vo['ad_id'])); ?>" class="btn blue"><i class="fa fa-pencil-square-o"></i>编辑</a> </div>
                  </div>
                </td>

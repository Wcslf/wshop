<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/seller/new/goods/brandList.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/head.html";i:1540447900;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/left.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/foot.html";i:1559461632;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Goods/brandList'); ?>">品牌列表</a></li>
                </ul>
                <a href="<?php echo U('Goods/addEditBrand'); ?>" class="ncbtn ncbtn-mint" title="添加品牌"><i class="icon-plus-sign"></i>添加品牌</a>
            </div>
            ...
            <form id="search-form2" method="post" action="<?php echo U('Goods/brandList'); ?>">
            ...
            <table class="ncsc-default-table">
                ...
                <?php else: if(is_array($brandList) || $brandList instanceof \think\Collection || $brandList instanceof \think\Paginator): $i = 0; $__LIST__ = $brandList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        <td></td>
                        <td><?php echo $list['id']; ?></td>
                        <td class="tl"><?php echo $list['name']; ?></td>
                        <td><a href="<?php echo (isset($list['logo']) && ($list['logo'] !== '')?$list['logo']:'/public/images/default_goods_image_240.gif'); ?>" target="_blank"><img onmouseover="$(this).attr('width','80').attr('height','45');" onmouseout="$(this).attr('width','40').attr('height','30');" width="40" height="30" src="<?php echo (isset($list['logo']) && ($list['logo'] !== '')?$list['logo']:'/public/images/default_goods_image_240.gif'); ?>"/></a></td>
                        <td><?php echo $cat_list[$list[cat_id1]]; ?> <?php echo $cat_list[$list[cat_id2]]; ?></td>
                        <td>
                            <?php if($list[status] == 0): ?>正常<?php endif; if($list[status] == 1): ?>审核中<?php endif; if($list[status] == 2): ?>审核失败<?php endif; ?>
                        </td>
                        <td class="nscs-table-handle">
                            <?php if($list[status] != 0): ?>
                            <span><a href="<?php echo U('goods/addEditBrand',array('id'=>$list['id'],'p'=>$_GET[p])); ?>" class="btn-bluejeans"><i class="icon-edit"></i>

                                <p>编辑</p></a></span>
                            <span><a onclick="del('<?php echo $list[id]; ?>')" class="btn-grapefruit"><i class="icon-trash"></i>

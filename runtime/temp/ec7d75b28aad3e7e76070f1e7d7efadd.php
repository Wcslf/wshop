<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./application/seller/new/goods/_goods.html";i:1541581050;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/head.html";i:1540447900;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/left.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/foot.html";i:1559461632;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
                    ...
                    <div class="ncsc-form-goods active" id="tab_tongyong">
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <p class="hint">(积分商城专用，常规不填)兑换该商品可使用多少积分，积分比例1元:<?php echo $tpshop_config[shopping_point_rate]; ?>分,虚拟商品填写此项无效</p>
                            </dd>
                        </dl>
                        <dl>
                            <dt>商品关键词：</dt>
								        ...
								        <div class="clabackkj">
								          ...
								          <a ata-original-title="添加商品" onclick="add_image();" class="ncbtn ncbtn-grapefruit mt5"><i class="fa fa-plus"></i>添加缩略图</a>
								        	...
								        	<?php if(is_array($goodsImages) || $goodsImages instanceof \think\Collection || $goodsImages instanceof \think\Paginator): if( count($goodsImages)==0 ) : echo "" ;else: foreach($goodsImages as $k=>$vo): ?>
									            ...
									            <div class="ncsc-upload-btn"><a href="javascript:void(0);"   onclick="img_upload(10, 'file_<?php echo $k; ?>', 'goods_album', 'call_back2');"><p><i class="icon-upload-alt"></i>上传</p></a>
									             </div>
									          </li>
									      <?php endforeach; endif; else: echo "" ;endif; if(count($goodsImages) < 5): $__FOR_START_884298514__=count($goodsImages);$__FOR_END_884298514__=5;for($i=$__FOR_START_884298514__;$i < $__FOR_END_884298514__;$i+=1){ ?>
                                                        <li class="ncsc-goodspic-upload">
                                                            ...
                                                            <div class="ncsc-upload-btn"><a href="javascript:void(0);"
                                                                                            onclick="img_upload(10, 'file_<?php echo $i; ?>', 'goods_album', 'call_back2');"><span></span>
...
<script>
    ...
    function add_image(){
    	...
    	//第三个: a标签, 上传图片按钮
    	last_li.find("a:eq(2)").unbind('click').removeAttr('onclick').click(function(){  img_upload(10,  new_id, 'goods_album', 'call_back2') });

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:43:"./application/admin/view/index/welcome.html";i:1610684807;}*/ ?>
<html>
<head>
                    ...
                    <!--<div class="sc_warp" style="padding-bottom: 30px;">-->
                        <!--<table cellpadding="0" cellspacing="0" class="system_table">-->
                            ...
                            <!--<tr>-->
                                ...
                                <!--<td><?php echo (isset($tpshop_config['shop_info_store_title']) && ($tpshop_config['shop_info_store_title'] !== '')?$tpshop_config['shop_info_store_title']:'深圳二月鸟飞有限公司'); ?></td>-->
                                <!--<td class="gray_bg">版权所有:</td>-->
                                <!--<td>PHP源码社</td>-->
                            <!--</tr>-->
                            <!--<tr>-->
                                <!--<td class="gray_bg">PHP源码:</td>-->
                                <!--<td><a href="http://eryueniaofei.top" target="_blank">源码社</a></td>-->
                                <!--<td class="gray_bg">PHP源码:</td>-->
                                <!--<td><a href="http://bbs.tp-shop.cn" target="_blank">T交流论坛</a></td>-->
                            <!--</tr>-->
                            <!--</tbody></table>-->
                    <!--</div>-->
                <!--</div>-->

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./template/mobile/default/goods/ajaxComment.html";i:1532948114;}*/ ?>
<?php if($count > 0): ?>
            ...
            <span class="assess-wrapper"  >
                <div class="assess-top">
                    <span class="user-portrait">
                        <img src="<?php echo (isset($v['head_pic']) && ($v['head_pic'] !== '')?$v['head_pic']:'/template/mobile/default/static/images/user68.jpg'); ?>">
                    </span>
...
<?php else: ?>
    ...
    <!--没有内容时-e-->
<?php endif; ?>
<link href="/template/mobile/default/static/css/photoswipe.css" rel="stylesheet" type="text/css">
<script src="/template/mobile/default/static/js/klass.min.js"></script>
<script src="/template/mobile/default/static/js/photoswipe.js"></script>

<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/store/store_list.html";i:1532948112;s:73:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/layout.html";i:1559450922;}*/ ?>
<!doctype html>
<html>
<head>
				...
				<div class="sDiv">
					...
					<div class="sDiv2" style="margin-right: 10px;border: none;">
						<select name="store_state" class="form-control">
							...
							<option value="5" <?php if(\think\Request::instance()->get('store_state') == '5'): ?>selected<?php endif; ?>>已删除</option>
						</select>
					</div>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 120px;"><?php echo $sellers[$vo['store_id']]; ?></div>
							</td>
							<td align="left" class="">
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
                                    <?php if($vo['store_end_time'] == 0): ?>
                                        长期
                                        <?php else: ?>
                                        <?php echo date('Y-m-d',$vo['store_end_time']); endif; ?>
                                </div>
                            </td>
							<td align="center" class="">

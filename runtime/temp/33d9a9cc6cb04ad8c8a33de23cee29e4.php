<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./application/admin/view/store/apply_class_list.html";i:1532948112;s:73:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/layout.html";i:1559450922;}*/ ?>
<!doctype html>
<html>
<head>
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<?php if($vo['state'] == 0): ?>
										...
										<a href="<?php echo U('Store/apply_class_save',array('bid'=>$vo[bid],'state'=>2)); ?>" class="btn blue"><i class="fa fa-ban"></i>拒绝</a>
									<?php endif; ?>

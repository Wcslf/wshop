<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/goods/stock_list.html";i:1532948112;s:73:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/layout.html";i:1559450922;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="search-form" method="get" action="<?php echo U('Goods/stock_list'); ?>" onsubmit="return check_form();">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 150px;" class="">商家名称</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 130px;" class="">订单号</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">库存</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">库存类型</div>
                        </th>
                       <!-- <th align="center" abbr="article_time" axis="col6" class="">
                ...
                <table>
                    ...
                    <?php if(is_array($stock_list) || $stock_list instanceof \think\Collection || $stock_list instanceof \think\Paginator): $i = 0; $__LIST__ = $stock_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 200px;"><?php echo getSubstr($v['goods_name'],0,30); ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 300px;"><?php echo $v['goods_spec']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;"><?php echo $store[$v[store_id]]; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 130px;"><?php echo (isset($v['order_sn']) && ($v['order_sn'] !== '')?$v['order_sn']:"无"); ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 50px;"><?php echo $v['stock']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 60px;"><?php if(empty($v[order_sn]) || (($v[order_sn] instanceof \think\Collection || $v[order_sn] instanceof \think\Paginator ) && $v[order_sn]->isEmpty())): ?>货品库存<?php else: ?>商品库存<?php endif; ?></div>
                            </td>
                            <!--<td align="center" class="">-->
                                <!--<div style="text-align: center; width: 100px;"><?php echo $v['muid']; ?></div>-->
                            <!--</td>-->
                            <td align="center" class="">
                                <div style="text-align: center; width: 120px;"><?php echo date("Y-m-d H:i:s",$v['ctime']); ?></div>
                            </td>

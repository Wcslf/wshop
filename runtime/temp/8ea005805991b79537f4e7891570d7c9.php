<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/seller/new/admin/login.html";i:1532948110;}*/ ?>
...
<style type="text/css">
.sller_login {
    width: 100%;min-height: 979px;background: url(/public/static/images/seller/seller_login_bg.png) center center no-repeat;
}
.sller_login_warp {
...
.ecsc-login-container .login-left {
    float: left;width: 300px;height: 396px;background: url(/public/static/images/seller/login_left_bg.png) no-repeat;padding: 0 24px;
}
.ecsc-login-container .login-left h3 {
    font-size: 32px;color: #fff;line-height: 60px;margin-top: 50px;
}
...
.login-right .items .item i {
    background: url(/public/static/images/seller/logo_icon.png) no-repeat;width: 20px; height: 20px;display: none;float: right;margin-top: 10px;
}
.mb30 {
...
.login-right .items .item label {
    background: url(/public/static/images/seller/seller_login_checkbox.png) 0px 3px no-repeat;padding-left: 22px;color: #999;font-size: 14px;cursor: pointer;
}
...
.login-right .items .item .checked label {
    background: url(/public/static/images/seller/seller_login_checkbox.png) 0px -23px no-repeat;
}
</style>
</head>
<body>
    	...
    	<div class="sller_login_warp">
            ...
            <div class="ecsc-login-container">
                <div class="login-left">
                    <h3>商家管理中心</h3>
                    <span>请输入您注册店铺时申请的商家名称，登录密码为商城前台会员通用密码。</span>
                </div>
                <div class="login-right">
                	<div class="login-logo"><img src="<?php echo (isset($tpshop_config['shop_info_seller_login_logo']) && ($tpshop_config['shop_info_seller_login_logo'] !== '')?$tpshop_config['shop_info_seller_login_logo']:'/public/static/images/logo/seller_login_logo_default.png'); ?>" /></div>
                    <div class="items">
                    	<div class="item item_bor mb10">
                        	<b><img src="/public/static/images/seller/login_icon01.png" /></b>
                        	<input name="username" type="text" id="username" autocomplete="off" class="text valid" placeholder="用户名" />
                            <i></i>
                        </div>
                        <div class="item item_bor mb10">
                        	<b><img src="/public/static/images/seller/login_icon02.png" /></b>

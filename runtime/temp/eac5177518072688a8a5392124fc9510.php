<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view/goods/categoryList.html";i:1555901360;s:73:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/layout.html";i:1559450922;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <form method="post">
    ...
    <div class="page-footer" style="text-align: center;color: #666;font-size: 12px;height: 48px;line-height: 48px;border-top: 1px solid #eee;margin-top: 20px;">
        版权所有 © <a href="javascript:;" style="color: inherit;"><?php echo (isset($tpshop_config['shop_info_store_title']) && ($tpshop_config['shop_info_store_title'] !== '')?$tpshop_config['shop_info_store_title']:'深圳二月鸟飞有限公司'); ?></a>，并保留所有权利
    </div>
</div>
  <script>
      $(document).ready(function(){	

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:46:"./template/mobile/default/goods/goodsList.html";i:1532948114;s:74:"/www/wwwroot/shop.zequninfo.com/template/mobile/default/public/header.html";i:1532948114;s:75:"/www/wwwroot/shop.zequninfo.com/template/mobile/default/public/top_nav.html";i:1532948114;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
                ...
                <form action="" method="post">
                    <div class="sear-input">
                        <a href="<?php echo U('Goods/ajaxSearch'); ?>">
                            <input type="text" class="sear-input-search" placeholder="搜更多商品" value="<?php echo I('q')?>">
                        </a>
                    </div>
                </form>
            </div>
                    ...
                    <a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$vo[goods_id])); ?>" class="item">
                        <div class="sc_list se_sclist">
                            ...
                            <div class="deleshow fr">
                                ...
                                <p class="weight"><span>市场价</span><span><?php echo $vo[market_price]; ?></span></p>
                            </div>
                        </div>
                    </a>
                </div>
    ...
    <div class="screen_wi">
        <div class="classreturn loginsignup">
            <div class="content">
                <div class="ds-in-bl return seac_retu">
                    <a href="javascript:void(0);" ><img src="/template/mobile/default/static/images/return.png" alt="返回"></a>
                </div>
        ...
        <div class="popcover">
                <ul>
                    ...
                    <li>
                        <span <?php if(\think\Request::instance()->param('sel') == 'own_yes'): ?>class="ch_dg"<?php endif; ?>>
                        网站自营<input type="hidden"  value="own_yes" ></span>
                    </li>
                    <li>
                        <span <?php if(\think\Request::instance()->param('sel') == 'own_no'): ?>class="ch_dg"<?php endif; ?>>
                        入驻商家<input type="hidden"  value="own_no" ></span>
                    </li>
                    <li>
...
<script type="text/javascript">
    ...
    function ajax_sourch_submit()
    {
        ...
        $.ajax({
            type : "get",
            url:"<?php echo urldecode(U('Mobile/Goods/goodsList',array_merge($filter_param,array('sort'=>$_GET[sort],'sort_asc'=>$_GET[sort_asc],'sel'=>$_GET[sel])),''));?>/is_ajax/1/p/"+page,//+tab,

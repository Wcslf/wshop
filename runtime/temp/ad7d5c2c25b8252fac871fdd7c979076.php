<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:41:"./application/seller/new/order/index.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/head.html";i:1540447900;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/left.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/foot.html";i:1559461632;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
...
<div class="tabmenu">
  <ul id="tab" class="tab pngFix">
  	...
  	<li class="<?php if(\think\Request::instance()->param('order_status') == 5): ?>active<?php else: ?>normal<?php endif; ?>" data-val="5"><a  href="#">已关闭</a></li>
  </ul>
  </div>
<form method="get" action="<?php echo U('order/export_order'); ?>" id="search-form2">
  ...
  <table class="search-form">
    <tr>
      ...
      <th>下单时间</th>
      <td class="w378">
	      <input type="text" class="text w150" name="start_time" id="start_time" placeholder="开始时间" value="<?php echo $begin; ?>"/>
	      <input type="text" class="text w150" name="end_time" id="end_time" placeholder="结束时间" value="<?php echo $end; ?>"/>
	   </td>
     </tr>
     <tr> 
      <th>支付状态</th>

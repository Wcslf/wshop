<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./application/seller/new/goods/goods_offline.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/head.html";i:1540447900;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/left.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/foot.html";i:1559461632;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
	      ...
	      <td class="w160">
	          <select name="store_cat_id1" id="store_cat_id1" class="select">
	              ...
	              <?php if(is_array($store_goods_class_list) || $store_goods_class_list instanceof \think\Collection || $store_goods_class_list instanceof \think\Paginator): if( count($store_goods_class_list)==0 ) : echo "" ;else: foreach($store_goods_class_list as $k=>$v): ?>
	                  <option value="<?php echo $v['cat_id']; ?>" <?php if(\think\Request::instance()->param('store_cat_id1') == $v['cat_id']): ?>selected<?php endif; ?>> <?php echo $v['cat_name']; ?></option>
	              <?php endforeach; endif; else: echo "" ;endif; ?>
	          </select>
	      </td>

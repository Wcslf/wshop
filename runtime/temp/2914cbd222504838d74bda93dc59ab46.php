<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view/goods/_category.html";i:1540447900;s:73:"/www/wwwroot/shop.zequninfo.com/application/admin/view/public/layout.html";i:1559450922;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="explanation" id="explanation">
    ...
    <ul>
      ...
      <li>1.WEB(PC)端的图标直接找到分类图替换即可, 图标路径:template/pc/rainbow/static/images/nav-sea12c1afb5.png</li>
  ...
  <form action="<?php echo U('Goods/addEditCategory'); ?>" method="post" class="form-horizontal" id="category_form">
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" placeholder="手机分类名称" class="input-txt" name="mobile_name" maxlength="4" value="<?php echo $goods_category_info['mobile_name']; ?>">
          <span class="err" id="err_mobile_name" style="color:#F00; display:none;"></span>
          <p class="notic">最多四个字符，太长手机端显示不全</p>
        </dd>
      </dl>
      <dl class="row">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic"><strong style="color:orange;">此分类图片用于手机端显示, 并且只有三级分类上传的图片才有效</strong></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
      ...
      <?php if($goods_category_info['level'] == 3): ?>
        <dl class="row">
          <dt class="tit">
            <label>搜索模型</label>
          </dt>
          <dd class="opt">
            <div>
              ...
              <select name="cat_id3" id="cat_id3" class="form-control" style="width:250px;">
                <option value="0">请选择商品分类</option>
              </select><a id="cancel_type_all" class="ncap-btn" href="JavaScript:void(0);" onclick="cancel_type_all();">重置</a>
              ...
              <div class="ncap-type-spec-list" id="ajax_brandList" style="height:160px;overflow: auto;">
                <?php if(is_array($goods_category_list) || $goods_category_list instanceof \think\Collection || $goods_category_list instanceof \think\Paginator): if( count($goods_category_list)==0 ) : echo "" ;else: foreach($goods_category_list as $k=>$v): ?>
                  <dl>
                    ...
                    <dd>
                      <?php if(is_array($goods_type_list) || $goods_type_list instanceof \think\Collection || $goods_type_list instanceof \think\Paginator): if( count($goods_type_list)==0 ) : echo "" ;else: foreach($goods_type_list as $k2=>$v2): if(in_array($v['id'],$v2['category_list'])){ ?>

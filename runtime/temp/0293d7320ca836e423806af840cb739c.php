<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:38:"./template/pc/rainbow/index/index.html";i:1542876326;s:70:"/www/wwwroot/shop.zequninfo.com/template/pc/rainbow/public/header.html";i:1532948122;s:77:"/www/wwwroot/shop.zequninfo.com/template/pc/rainbow/public/header_search.html";i:1532948122;s:70:"/www/wwwroot/shop.zequninfo.com/template/pc/rainbow/public/footer.html";i:1532948122;s:76:"/www/wwwroot/shop.zequninfo.com/template/pc/rainbow/public/sidebar_cart.html";i:1532948122;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<body>
		<!--顶部广告-s-->
		<?php $pid =1;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
					...
					<li class="navoxth">
						...
						<div class="sub-panel m-lst">
							...
							<dl>
                                ...
                                <img height="80" width="80" img-url="/index.php?m=Home&c=Index&a=qr_code&data=<?php echo $mobile_url; ?>&head_pic=<?php echo $head_pic; ?>&back_img=<?php echo $back_img; ?>"/>
                                </a></dt>
	...
	<div class="nav tpshop2_0_nav p">
		...
		<div id="myCarousel" class="carousel slide p header-tp tpshop2_0_carousel">
			...
			<div class="carousel-inner">
				<?php $pid =10;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("6")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
				...
				<div class="usertpshop">
					<div class="head_index">
						<a href="<?php echo U('Home/User/index'); ?>" target="_blank">
							<img class="head_pic" src="<?php echo (isset($user['head_pic']) && ($user['head_pic'] !== '')?$user['head_pic']:'/template/pc/rainbow/static/images/default.jpg'); ?>" alt="" />
						</a>
					</div>
						...
						<div class="bn_box">
							<?php
                              ...
                              foreach($sql_result_item as $key=>$item): endforeach; 
                                ...
                                $md5_key = md5("select * from `__PREFIX__article` where cat_id = 9 and is_open=1 limit 4");
                                $box_prom = $sql_result_item = S("sql_".$md5_key);
                                if(empty($sql_result_item))
                                {                            
                                    $box_prom = $sql_result_item = \think\Db::query("select * from `__PREFIX__article` where cat_id = 9 and is_open=1 limit 4"); 
                                    S("sql_".$md5_key,$sql_result_item,31104000);
                                }    
		...
		<div class="fn-mall p ma-to-20">
			<div class="w1224">
				...
				<div class="advertisement p">
					<ul>
						<?php $pid =50;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
				...
				<div class="feture-cates ma-to-20 p">
					<ul class="cates-left">
						<?php $pid =51;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("6")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
					...
					<div id="myCarouselq" class="carousel slide p w408 fl">
						...
						<div class="carousel-inner">
							<div class="item active">
                                <?php $pid =52;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
							...
							<div class="item">
                                <?php $pid =53;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
					...
					<ul class="cates-right">
                        <?php $pid =54;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
					...
					<ul>
                            <li>
                                ...
                                <div class="boxforborder">
                                    <?php $pid =105;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $k=>$v105):       
    ...
    ?>
                        ...
                        <li>
                            ...
                            <div class="boxforborder">
                            <?php $pid =106;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $k=>$v106):       
    ...
    ?>
                        ...
                        <li>
                            ...
                            <div class="boxforborder">
                            <?php $pid =107;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $k=>$v107):       
    ...
    ?>
                            ...
                            <div class="boxforborder">
                            <?php $pid =108;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $k=>$v108):       
    ...
    ?>
                        ...
                        <li>
                            ...
                            <div class="boxforborder">
                            <?php $pid =109;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $k=>$v109):       
    ...
    ?>
		...
		<div class="floor-advert p">
			<div class="w1224">
                <?php $pid =99;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1610784000 and end_time > 1610784000 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
			...
			<div class="w1224">
				<div class="uantit fixedu p" >
					...
					<ul class="f-tab fr">
						...
						<?php if(is_array($wb[recommend_list]) || $wb[recommend_list] instanceof \think\Collection || $wb[recommend_list] instanceof \think\Paginator): if( count($wb[recommend_list])==0 ) : echo "" ;else: foreach($wb[recommend_list] as $rck=>$rcd): if(isset($rcd[recommend])): ?>
				...
				<div class="uanmain fixedu p">
					<div class="leftcol fl">
						...
						<div class="lc_bot">
							<ul>
								<li class="rowhr">
									<a href="<?php echo $wb[act][urla]; ?>"><span><?php echo $wb[act][titlea]; ?></span><i class="r_arrow"></i></a>
    ...
    <img data-original="<?php echo (isset($ad[adv_info][pic_img]) && ($ad[adv_info][pic_img] !== '')?$ad[adv_info][pic_img]:'/public/images/icon_goods_thumb_empty_300.png'); ?>" class="lazy" width="199" height="243"/>
						...
						<div class="content_goods_sh content_goods_list" id="wbg<?php echo $gk+1; ?>" style="display:none;">
							<ul class="floor-list-cont">
								<?php if(isset($wg[goods_list])): if(is_array($wg[goods_list]) || $wg[goods_list] instanceof \think\Collection || $wg[goods_list] instanceof \think\Paginator): if( count($wg[goods_list])==0 ) : echo "" ;else: foreach($wg[goods_list] as $key=>$pd): ?>
								<li>

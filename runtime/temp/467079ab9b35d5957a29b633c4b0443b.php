<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/seller/new/goods/stock_list.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/head.html";i:1540447900;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/left.html";i:1532948110;s:71:"/www/wwwroot/shop.zequninfo.com/application/seller/new/public/foot.html";i:1559461632;}*/ ?>
<!doctype html>
<html>
<head>
<meta charset="utf-8">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Goods/stock_list'); ?>">库存列表</a></li>
                    <li><a href="<?php echo U('Goods/stock_log'); ?>">库存日志</a></li>
                </ul>
            </div>
            <form id="search-form2" method="post" action="">
                ...
                <table class="search-form">
                    <tr>
                        ...
                        <td class="w100"><input style="width: 90px;" class="text" type="text" value="<?php echo $_REQUEST[goods_name]; ?>" name="goods_name"/></td>
                        <th>规格名称</th>
                        <td class="w100">
                            <input type="text" style="width: 90px;" class="text w90" id="spec_name" name="spec_name" value="<?php echo $_REQUEST[spec_name]; ?>" />
                        </td>
            ...
            <table class="ncsc-default-table">
                ...
                <tr>
                    ...
                    <th class="w50">状态</th>
                    <th class="w50">活动状态</th>
                </tr>
                </thead>
                <tbody>
                <?php if(empty($stock_list) || (($stock_list instanceof \think\Collection || $stock_list instanceof \think\Paginator ) && $stock_list->isEmpty())): ?>
			        <tr>
			            <td colspan="20" class="norecord"><div class="warning-option"><i class="icon-warning-sign"></i><span>暂无符合条件的数据记录</span></div></td>
			        </tr>
			    <?php else: if(is_array($stock_list) || $stock_list instanceof \think\Collection || $stock_list instanceof \think\Paginator): $i = 0; $__LIST__ = $stock_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        <td></td>
                        <td><?php echo $v['item_id']; ?></td>
                        <td><?php echo getSubstr($goods[$v[goods_id]],0,30); ?></td>
                        ...
                        onchange="updateStock(this)" old-stock="<?php echo $v['store_count']; ?>" data-id="<?php echo $v['item_id']; ?>" value="<?php echo $v['store_count']; ?>" <?php if($v['prom_type'] != 0): ?>disabled<?php endif; ?> />
                        </td>
                        <td><?php if($v[store_count] < 10): ?><b style="color:orange;">预警</b><?php else: ?><b style="color:green;">正常</b><?php endif; ?></td>
                        <td <?php if($v['prom_type'] != 0): ?>style="color:red;"<?php endif; ?>><?php echo $v['prom_desc']; ?></td>
                    </tr>
...
<script>
    ...
    function updateStock(obj){
        $.ajax({
            type:'GET',
            url:"<?php echo U('Goods/updateGoodsStock'); ?>",
